...
- [x] **Task 1 — pnpm project + package.json** [`tests/unit/project-structure.test.ts`]
...
- [x] **Task 2 — TypeScript + Vite configuration** [`tests/unit/build.test.ts`]
...
- [x] **Task 3 — Biome lint/format** [`tests/unit/lint.test.ts` (shell-exec)]
  - `biome.json` present and valid.
  - `pnpm lint` exits 0 on the initial codebase.
  - Ref: `99-build-deploy.md §CI Gate List`.

- [x] **Task 4 — Vitest configuration (node + browser projects)** [`tests/unit/vitest-smoke.test.ts`]
...
- [x] **Task 5 — Playwright configuration** [`tests/visual/smoke.spec.ts`]
...
- [x] **Task 6 — Capacitor Android configuration** [`tests/unit/capacitor.test.ts`]
...
- [x] **Task 7 — Asset manifest types + typed accessor** [`tests/unit/asset-accessor.test.ts`]
...
- [x] **Task 8 — Ingest script** [`tests/unit/ingest.test.ts`]
...
- [x] **Task 9 — Asset verification script + contract test** [`tests/unit/asset-manifest.test.ts`]
...
- [x] **Task 10 — Pillar documentation set** [`tests/unit/docs-present.test.ts`]
...
- [x] **Task 11 — GitHub Actions CI workflow** [`tests/unit/ci-config.test.ts` (shell-exec)]
  - `.github/workflows/ci.yml` exists and is valid YAML.
  - Workflow defines all 9 CI gates in order.
  - `act` dry-run (or yaml-parse test) exits 0.
  - Ref: `99-build-deploy.md §CI Gate List`.

- [x] **Task 12 — GitHub Pages deploy workflow** [`tests/unit/pages-config.test.ts`]
...
- [x] **Task 13 — Coverage gates + standard repo files** [`tests/unit/gates.test.ts`]
