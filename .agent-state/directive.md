...
- [ ] [HIGH] M_POLISH2.MODES.42a — strata-wars 80%-control-for-30s win condition: add a `controlTimer` to GameState (seconds the player has held ≥80% zone control); when it hits 30, flip outcome to 'win'. Reset to 0 when control drops below 80.
