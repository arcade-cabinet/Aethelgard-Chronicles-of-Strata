...
- [ ] [HIGH] M_POLISH2.RTS.23 — Sentry tower: Scout has landed (RTS.22 done). This is now a small BuildingProfile addition — add a Sentry building that extends Scout vision when adjacent.
...
- [ ] [HIGH] M_POLISH2.X4.31 — Espionage / scout-sight: Scout has landed (RTS.22 done). Implement scout-sight mechanic.
