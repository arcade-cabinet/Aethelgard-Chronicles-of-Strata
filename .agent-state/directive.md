...
- [ ] M_HUD.SHELL.20b — ResourceBar bottom-shelf migration on narrow viewports: Build button + EndTurn join a touch-reachable bottom shelf with FactionChips trigger so the entire top band becomes ONLY the WinPill + SystemMenu trigger.
