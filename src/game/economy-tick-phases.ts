...
import { animationSystem } from '@/ecs/systems/movement';
import { buildSystem } from '@/ecs/systems/lifecycle';
import { buildingDeathSystem } from '@/ecs/systems/lifecycle';
...
import { waveDefenseSystem } from '@/ecs/systems/combat';
import { depositSystem, type ResourceDepositEvent } from '@/ecs/systems/economy';
...
import { scienceSystem } from '@/ecs/systems/economy';
...
import { volcanoSystem } from '@/ecs/systems/hazards';
import { wanderSystem } from '@/ecs/systems/movement';
import { wildfireSystem } from '@/ecs/systems/hazards';
...
import { tickEnemyAtPalaceToast, tickInactivityBeats } from './narrative';
import { tickLongReignEscalation, tickRandomEvents } from './narrative';
